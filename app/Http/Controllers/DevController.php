...
class DevController extends Controller
{
    ...
    {
        $list_detailcategory['list_detailcategory'] = DB::table('detail_category_products')->where('category_id', '=', $id)->where('status','=','1')->get();
        return $list_detailcategory;
    }
    public function subTag($id)
    {
        $list_subStartupTag['list_subStartupTag'] = DB::table('sub_startup_tags')->where('startuptag_id', '=', $id)->where('status','=','1')->get();
