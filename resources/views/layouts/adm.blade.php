...
<head>
    ...
    <title>Sistem Informasi ECC</title>
...
<body>
    ...
    <!-- Left Panel -->
    <aside id="left-panel" class="left-panel fixed-top" style="overflow-y: hidden;">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu navbar-collapse collapse" style="">
                ...
                <div class="col-sm-12">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="{{ route('dev.akun') }}">
                                {{ __('Pengaturan Akun') }}
                            </a>
