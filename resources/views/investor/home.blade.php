        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
                ...
                <p class="lead">Kumpulan-kumpulan Startup dari Developer Terbaik, dan Jadilah Angel Investor pada Startup</p>
                 ...
                 <br>
                <a type="button" class="btn btn-outline-danger" href="{{ route('inv.startup') }}">Klik Untuk Investasi Sekarang Juga</a>
                
                <div class="arrow bounce">
                    <a class="fa fa-arrow-down fa-1x" href="#"></a>
                    <h4>Lihat Trending Startup</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-n7 mt-lg-n13 z-2">
        <div class="row justify-content-center">
            ...
            <div class="col-12 text-center">
                <h1 class="h1 font-weight-bolder mb-4 px-lg-8 text-white">Trending Startup</h1>
            </div>
        </div>
