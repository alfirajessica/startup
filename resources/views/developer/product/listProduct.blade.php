<div class="row">
    <div class="col-md-12">
        <h4><strong>List Semua Proyek </strong></h4>
        <p>Silakan pilih tab dibawah ini</p>
    </div>
</div>
<div class="row">
    <div class="col">
        ...
        <div class="tab-content py-4 bg-white" id="myTabContent">
            <div class="tab-pane fade" id="confirm" role="tabpanel" aria-labelledby="confirm-tab">
                <div class="col-md-12">
                    ...
                    <div class="alert alert-default px-2" role="alert">
                        <strong>Menunggu Konfirmasi</strong> adalah project yang statusnya belum aktif dan butuh konfirmasi Admin
                    </div>
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="col-md-12">
                    <div class="alert alert-default px-2" role="alert">
                        Daftar project dibawah ini adalah project yang ditampilkan pada katalog Startup
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="col-md-12">
                    <div class="alert alert-default px-2" role="alert">
                        Daftar project dibawah ini adalah project yang memiliki investor
                    </div>
                </div>
