                ...
                <div class="card-body border-1"> <!-- card-body -->
                    <div class="nav-wrapper"> <!-- nav-wrapper -->
                        ...
                        <ul class="nav nav-pills nav-fill flex-column flex-md-column" id="tabs-icons-text" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-icons-text-1-tab" data-toggle="tab" href="#tabs-icons-text-1" role="tab" aria-controls="tabs-icons-text-1" aria-selected="true"><i class="ni ni-cloud-upload-96 mr-2"></i>Produk Baru</a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="col">
                                    <form action="">
                                        <div class="form-group">
                                            <label for="nama_event">Email Developer/Startup</label>
                                            <input type="text" class="form-control" id="nama_event" aria-describedby="nama_eventHelp" >
                                        </div>


                                        <div class="form-group">
                                            <label for="nama_event">Nama Developer/Startup</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleTextarea">Deskripsi Startup</label>
                                            <textarea class="form-control" id="exampleTextarea" rows="3"></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleTextarea">Tim Startup</label>
                                            <textarea class="form-control" id="exampleTextarea" rows="3"></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleTextarea">Keuntungan Startup</label>
                                            <textarea class="form-control" id="exampleTextarea" rows="3"></textarea>
                                        </div>
            
                                        <div class="form-group">
                                            <label for="exampleTextarea">Produk yang didevelop</label>
                                            <textarea class="form-control" id="exampleTextarea" rows="3"></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleTextarea">Target Pasar</label>
                                            <textarea class="form-control" id="exampleTextarea" rows="3"></textarea>
                                        </div>
